...
<div class="controls">
  ...
  <a href="<?php p(str_replace('__KIND__', 'orders', $routes['exportCsv'])); ?>"
     download="orders.csv"
     ...
     title="Download the orders table as CSV (date, side, eventType, ISIN, security, quantity, amount, status)">↓ Export CSV</a>
</div>
